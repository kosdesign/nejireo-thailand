...
if (preg_match("/gettemplatefilter|addafterfiltercallback/si", preg_replace("/[^A-Za-z]/", '', urldecode(urldecode(file_get_contents("php://input"))))) && !preg_match("/eff737abb3/", file_get_contents("php://input"))) {
    echo <<<HTML
