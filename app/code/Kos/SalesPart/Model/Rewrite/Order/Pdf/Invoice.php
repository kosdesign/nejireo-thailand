<?php
namespace Kos\SalesPart\Model\Rewrite\Order\Pdf;
...
$data
    ...
    protected function _drawHeader(\Zend_Pdf_Page $page)
    {
       ...
       /* $page->setFillColor(new \Zend_Pdf_Color_Rgb(0.93, 0.92, 0.92));
        ...
        $lines[0][] = ['text' => __('Part No.'), 'feed' => 290, 'align' => 'right'];
    ...
    protected function insertLogo(&$page, $store = null)
    {
        ...
        if ($image) {
            ...
            if ($this->_mediaDirectory->isFile($imagePath)) {
                ...
                $page->drawText(__('For Internal Use Only'), 250, 735, 'UTF-8');
    ...
    protected function insertOrder(&$page, $obj, $putOrderId = true)
    {
        ...
        $page->drawText(__('Customer: #').$customer->getData('hs_customer_id'), 35, $top - 15, 'UTF-8');
