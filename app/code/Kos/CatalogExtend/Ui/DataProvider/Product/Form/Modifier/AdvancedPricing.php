 ...
 */
namespace Kos\CatalogExtend\Ui\DataProvider\Product\Form\Modifier;
...
use Magento\Catalog\Ui\DataProvider\Product\Form\Modifier\AdvancedPricing as AdvancedPricingCore;

class AdvancedPricing extends AdvancedPricingCore
{
    /**
     * @inheritdoc
     *
    ...
    private function getCustomerGroups()
    {
        ...
        $customerGroupSource = ObjectManager::getInstance()->get(GroupSourceInterface::class);
     ...
     *
     * @return $this|AdvancedPricingCore
