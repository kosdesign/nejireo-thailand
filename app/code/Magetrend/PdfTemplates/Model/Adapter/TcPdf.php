...
class TcPdf extends AdapterAbstract
{
    ...
    public function __construct(
        ...
        \Magetrend\PdfTemplates\Model\Adapter\TcPdf\OrderFactory $orderFactory,
        \Magetrend\PdfTemplates\Model\Adapter\TcPdf\InvoiceFactory $invoiceFactory,
        \Magetrend\PdfTemplates\Model\Adapter\TcPdf\ShipmentFactory $shipmentFactory,
        \Magetrend\PdfTemplates\Model\Adapter\TcPdf\CreditmemoFactory $creditmemoFactory,
    ...
    public function getPdf($objects = [], $forceTemplateId = null)
    {
        ...
        foreach ($objects as $object) {
            ...
            if ($object instanceof \Magento\Sales\Model\Order) {
                ...
                $pdfProcessor = $this->creditmemoFactory->create();
            } else {
                $templateId = 0;
            }
