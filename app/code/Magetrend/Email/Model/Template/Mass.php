...
class Mass
{
    ...
    public $systemConfigMap = [
        ...
        [
            'path' => \Magento\SendFriend\Helper\Data::XML_PATH_EMAIL_TEMPLATE,
    ...
    public function createTemplates($storeId = 0)
    {
        $templateList = $this->template->getTemplateList();
    ...
    public function updateTemplates($storeId = 0)
    {
