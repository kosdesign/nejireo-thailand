...
class Data extends CoreHelper
{
    ...
    public function getObjectByParam($value, $code = null, $type = null)
    {
        ...
        if($type == null) {
            $object = $this->getObjectList(self::TYPE_POST, $this->storeManager->getStore()->getId())
    ...
    public function checkUrlKey($resource, $object, $urlKey)
    {
        ...
        if($resource->getMainTable() == 'mageplaza_blog_post') {
            $select->where('store_ids in (:store_id)');
            $binds['store_id'] = (string)$object->getStoreIds();
